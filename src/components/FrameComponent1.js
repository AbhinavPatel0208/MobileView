const FrameComponent1 = () => {
  return (
    <section className="self-stretch h-[418px] flex flex-col items-start justify-start py-0 px-4 box-border gap-[24px] text-left text-base text-text font-nunito">
      ...
      <div className="self-stretch rounded-3xs bg-light-gohan shadow-[4px_4px_15px_rgba(0,_0,_0,_0.04)] flex flex-col items-center justify-start p-4 gap-[16px] text-center text-sm text-dark-trunks font-paragraph-ui-type-text-md-s">
